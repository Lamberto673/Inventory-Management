...
const DashBoardPage = async () => {
  ...
  const outStockCount = allProducts.filter((p) => Number(p.quantity) === 0).length;
      ...
      <main className='ml-64 p-8'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8'>
          <div className='bg-white rounded-lg border border-gray-200 p-6'>
            <h2 className='text-lg font-semibold text-gray-900 mb-6'>Key Metrics
            </h2>
            ...
            <div className='bg-white rounded-lg border border-gray-200 p-6'>
              ...
              <div className='space-y-3'>
                  {recent.map((product, key) => {
                    ...
                    return (
                      <div className='flex items-center justify-between p-3 rounded-lg bg-gray-50 ' key={key}>
            ...
            <div className='bg-white rounded-lg border border-gray-200 p-6'>
              ...
              <div className='flex items-center justify-center'>
                  <div className='relative w-48 h-48'>
                    ...
                    <div className='absolute inset-0 rounded-full border-8 border-blue-600' style={{
                      ...
                      <div className='flex items-center justify-between text-sm text-gray-600'>
                       ...
                       <div className='flex items-center justify-between text-sm text-gray-600'>
                        <div className='flex items-center space-x-2'>
                          ...
                          <span>In Stock({outStockPercentage}%)</span>
                       </div>
                      </div>
              </div>
            </div>
